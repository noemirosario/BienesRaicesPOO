function eventListeners(){document.querySelector(".mobil-menu").addEventListener("click",navegacionResposive)}function navegacionResposive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
